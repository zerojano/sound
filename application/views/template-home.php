...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?= base_url('/login/salir'); ?>"><i class="fa fa-power-off fa-fw"></i> Salir</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?= base_url('/home/backup'); ?>"><i class="fa fa-database fa-fw"></i> Respaldos<span class="fa arrow"></span></a>
                        </li>
                        <li>
                            <a href="<?= base_url('/login/salir'); ?>"><i class="fa fa-power-off fa-fw"></i> Salir<span class="fa arrow"></span></a>
                        </li>
                        <!--
                        <li>
    ...
    <script src="<?= base_url(); ?>public/data/morris-data.js"></script>
